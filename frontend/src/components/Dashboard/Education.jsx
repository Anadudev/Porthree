...
const EducationsComponent = () => {
  ...
  useEffect(() => {
    const fetchEducations = async () => {
      setIsLoading(true);
      try {
        const response = await axios.get(`${api.apiHost}/api/users/${userId.id}/educations/`);
  ...
  const handleAddEducation = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${api.apiHost}/api/educations/`, educationData, {
        headers: {
  ...
  const handleDeleteEducation = async (educationId) => {
    ...
    try {
      ...
      await axios.delete(`${api.apiHost}/api/educations/${educationId}/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleUpdateEducation = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${api.apiHost}/api/educations/${editingEducation.id}/`, educationData, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json', // Assuming the API expects JSON data
        },
